...
void main() {
    ...
    float hx = TerrainHighRes(worldPos + e.xy) - TerrainHighRes(worldPos - e.xy);
    float hz = TerrainHighRes(worldPos + e.yx) - TerrainHighRes(worldPos - e.yx);
